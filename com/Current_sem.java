 ...
 */
public class Current_sem extends Application {
    ...
    public void start(Stage primaryStage) throws Exception {
        ...
        TableColumn cat = new TableColumn("CAT");
        TableColumn pbl = new TableColumn("PBL");
        TableColumn fat = new TableColumn("FAT");
        TableColumn grade = new TableColumn("Grade");

        table.getColumns().addAll(course_code, course_title, cat, pbl, fat, grade);
